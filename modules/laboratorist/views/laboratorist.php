    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-user-md mr-2"></i><?php echo lang('laboratorist') ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang('All the laboratorist names and related informations'); ?></h3>
                            ...
                            <table class="table table-bordered table-hover" id="editable-sample">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($laboratorists as $laboratorist) { ?>
                                        <tr class="">
                                            <td class="align-middle"><img class="img-fluid rounded-circle" style="width: 50px; height: 50px;" src="<?php echo $laboratorist->img_url; ?>"></td>
                                            ...
                                            <td class="align-middle no-print">
                                                ...
                                                <button type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $laboratorist->id; ?>"><i class="fa fa-edit"></i></button>
                                                <a class="btn btn-danger btn-sm delete_button" title="<?php echo lang('delete'); ?>" href="laboratorist/delete?id=<?php echo $laboratorist->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add_new_laboratorist'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form role="form" action="laboratorist/addNew" class="clearfix form-row" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit_laboratorist'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form role="form" id="editLaboratoristForm" class="clearfix form-row" action="laboratorist/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('name'); ?> &ast;</label>
                    ...
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3">Phone &ast;</label>
                        <input type="number" class="form-control col-sm-9" name="phone" value='' placeholder="" required="">
                    </div>
