                        ...
                        <div class="card-body">
                            ...
                            <form role="form" action="pservice/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group d-flex">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('service'); ?> <?php echo lang('name'); ?></label>
                                ...
                                <div class="form-group d-flex">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('service'); ?> <?php echo lang('code'); ?></label>
                                ...
                                <div class="form-group d-flex">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('alpha_code'); ?></label>
                                    <input type="text" class="form-control col-sm-9" name="alpha_code" id="exampleInputEmail1" value='<?php
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <input type="text" class="form-control col-sm-9" min="0" name="price" id="exampleInputEmail1" value='<?php
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <input type="checkbox" class="" name="active" id="exampleInputEmail1" value='' <?php
                                                                                                                    ...
                                                                                                                    ?>>
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('active'); ?></label>
                                </div>
