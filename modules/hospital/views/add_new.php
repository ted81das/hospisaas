                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <input type="text" class="form-control col-sm-9" name="email" value='<?php
                                        ...
                                        <div class="form-group d-flex">
                                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('frontend_website_link'); ?> &ast; </label>

                                            <input type="text" class="form-control col-sm-9" autocomplete="off" name="username" data-id="<?php
                                                                                                                                            if (!empty($hospital->id)) {
                                                                                                                                                echo $hospital->id;
                                                                                                                                            }
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('language'); ?></label>
                                    ...
                                    <?php if (empty($hospital->id)) { ?>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group package_select_div d-flex">
                                                <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('package'); ?></label>
                                            ...
                                            <div class="form-group d-flex">
                                                <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('patient'); ?> <?php echo lang('limit'); ?></label>
                                                <input type="text" class="form-control col-sm-9" id="p_limit" name="" value='' placeholder="" readonly="">
                                            </div>

                                            <div class="form-group d-flex">
                                                <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('doctor'); ?> <?php echo lang('limit'); ?></label>
                                                <input type="text" class="form-control col-sm-9" id="d_limit" name="" value='' placeholder="" readonly="">
                                            </div>

                                            <div class="form-group col-md-12 row" id="modules_list">
                                                <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('permited_modules'); ?> </label>
                                            </div>
                                            ...
                                            <div class="form-group pos_client" style="display: none;">
                                                <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('module_permission'); ?></label>
                                                <br>
                                        ...
                                        <div class="form-group col-md-6 package_duration_div d-flex">
                                            <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('package_duration'); ?></label>
                                        ...
                                        <div class="form-group col-md-6 d-flex">
                                            <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('price'); ?></label>
                                            <input type="text" class="form-control col-sm-9 price-input" name="price" value='' placeholder="">
                                        </div>

                                    <?php } ?>
                                    <div class="form-group col-md-6 d-flex">
                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('country'); ?></label>
                                        ...
                                        <?php if (empty($hospital->id)) { ?>
                                            ...
                                            <div class="cardPayment row">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group d-flex">
                                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('card'); ?></label>
                                                    ...
                                                    <div class="form-group d-flex">
                                                        ...
                                                        <input type="text" class="form-control col-sm-9" name="cardholder" value='' placeholder="">
                                                    </div>
                                                ...
                                                <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack') { ?>
                                                    ...
                                                    <div class="form-group d-flex">
                                                        ...
                                                        <input type="text" class="form-control col-sm-9" id="card" name="card_number" value='' placeholder="">
                                                    </div>


                                                    <div class="form-group d-flex">
                                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('expire'); ?> <?php echo lang('date'); ?></label>
                                                        <input type="text" class="form-control col-sm-9" id="expire" data-date="" data-date-format="MM YY" placeholder="Expiry (MM/YY)" name="expire_date" maxlength="7" aria-describedby="basic-addon1" value='' placeholder="">
                                                    </div>

                                                    <div class="form-group d-flex">
                                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('cvv'); ?></label>
                                                        <input type="text" class="form-control col-sm-9" id="cvv" name="cvv_number" value="" placeholder="" maxlength="3">
                                                    </div>
