                                        ...
                                        <div class="card-body">
                                            ...
                                            <form role="form" action="doctorvisit/addNew" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" id="adoctors" name="doctor" required="">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="visit_description" id="visit_description" value='<?php
                                                                                                                                                        if (!empty($setval)) {
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="visit_charges" id="visit_charges" value='<?php
                                                                                                                                                if (!empty($setval)) {
