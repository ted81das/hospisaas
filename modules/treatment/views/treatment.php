            ...
            <div class="row my-2 pl-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="treatment"><?php echo lang('treatment_list') ?></a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang('Comprehensive List of Treatment'); ?></h3>

                            <div class="float-right">
                                <a data-toggle="modal" href="#myModal">
                                    <button id="" class="btn btn-success btn-sm">
                                        <i class="fa fa-plus-circle"></i> <?php echo lang('add_treatment'); ?>
                                    </button>
                                </a>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="treatment/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('icd-10-pcs'); ?> <?php echo lang('code'); ?></label>
