     ...
     <section class="content-header">
         <div class="container-fluid">
             <div class="row my-2 pl-1">
                 <div class="col-sm-6">
                     <h1 class="font-weight-bold"><i class="fas fa-user-md mr-2"></i><?php echo lang('pharmacist') ?></h1>
                 </div>
                 <div class="col-sm-6">
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title font-weight-bold"> <?php echo lang('add_new_pharmacist'); ?></h4>
             ...
             <div class="modal-body">
                 <form role="form" action="pharmacist/addNew" class="clearfix form-row" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group col-md-6 d-flex">
                         ...
                         <input type="password" class="form-control col-sm-9" name="password" placeholder="" autocomplete="off" required="">
                     </div>
                     <div class="form-group col-md-6 d-flex">
 ...
 <div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title font-weight-bold"> <?php echo lang('edit_pharmacist'); ?></h4>
                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
             </div>
             <div class="modal-body">
