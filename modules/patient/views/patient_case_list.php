            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="profile-nav d-flex justify-content-between">
                                    ...
                                    <ul class="list-unstyled mt-4 text-md">
                                        <li> <?php echo lang('patient_id'); ?> # <span class="ml-5 badge badge-primary float-end"><?php echo $patient->id; ?></span></li>
                                        <li> <?php echo lang('gender'); ?><span class="ml-5 badge badge-primary float-end"><?php echo $patient->sex; ?></span></li>
                                        <li> <?php echo lang('birth_date'); ?><span class="ml-5 badge badge-primary float-end"><?php echo $patient->birthdate; ?></span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <form role="form" action="patient/addMedicalHistory" id="medical_historyEditForm" class="clearfix w-100" method="post" enctype="multipart/form-data">
                                    <div class="">
                                        <div class="form-group d-flex">
                                            ...
                                            <input type="text" class="form-control default-date-picker" id="case_date" name="date" placeholder="" autocomplete="off" required="" value='<?php
                                                                                                                                                                                        if (!empty($case->id)) {
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <input type="text" class="form-control" id="case_title" name="title" placeholder="" required="" value="<?php
                                                                                                                                                    if (!empty($case->id)) {
                                                                                                                                                        echo $case->title;
                                                                                                                                                    }
                                                                                                                                                    ?>">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select class="form-control m-bot15 col-sm-7" multiple id="symptomchoose1" name="symptom_id[]">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select class="form-control m-bot15 col-sm-7" multiple id="testchoose1" name="test_id[]">
                                                <?php if (!empty($case->id)) { ?>
                                                    <option><?php echo lang('select'); ?></option>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select class="form-control m-bot15 col-sm-7" multiple id="diagnosischoose1" name="diagnosis_id[]">
                                                <?php if (!empty($case->id)) { ?>
                                                    <option><?php echo lang('select'); ?></option>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select class="form-control m-bot15 col-sm-7" multiple id="treatmentchoose1" name="treatment_id[]">
                                                <?php if (!empty($case->id)) { ?>
                                                    <option><?php echo lang('select'); ?></option>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select class="form-control m-bot15 col-sm-7" multiple id="advicechoose1" name="advice_id[]">
                                                <?php if (!empty($case->id)) { ?>
                                                    <option><?php echo lang('select'); ?></option>
