            ...
            <div class="row my-2 pl-1">
                ...
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">
                        <i class="fas fa-user-injured mr-2"></i><?php echo lang('patient'); ?> <?php echo lang('info'); ?>
                    </h1>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="profile-nav">
                                    ...
                                    <ul class="list-unstyled mt-4 text-md">
                                                                    ...
                                                                    <tr class="">
                                                                        ...
                                                                        <?php if (!$this->ion_auth->in_group('Patient')) { ?>
                                                                            <td class="no-print edit_appointment_button">
                                                                                <button type="button" class="btn btn-sm btn-primary editAppointmentButton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $appointment->id; ?>"><i class="fa fa-edit"></i> </button>
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($vital_signs as $vital_sign) { ?>
                                                                    <tr class="">
                                                                        ...
                                                                        <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                                            <td class="no-print vitalSignTable d-flex gap-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr class="">
                                                                        ...
                                                                        <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                                            <td class="no-print medical_history_button d-flex gap-1">
                                                                                ...
                                                                                <a class="btn btn-sm btn-danger" title="<?php echo lang('delete'); ?>" href="patient/deleteCaseHistory?id=<?php echo $medical_history->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                                                                <?php echo $options4 ?>
                                                                            </td>
                                                                        <?php } ?>
                                                                    </tr>
                                                ...
                                                <div class="">
                                                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn btn-sm btn-success" data-toggle="modal" href="#myModal1">
                                                                <i class="fa fa-plus-circle"> </i> <?php echo lang('add_file'); ?>
                                                            </a>


                                                            <a class="btn btn-sm btn-success float-right" data-toggle="modal" href="#myModalf">
                                                            ...
                                                            ?>
                                                                    <div class="card col-md-3 patient_material_class1 my-5">
                                                                        ...
                                                                        <div class="col-md-7 float-right patient_material_url">
                                                                            ...
                                                                            <div class="post-info">
                                                                                <a class="btn btn-blue btn-sm" href="<?php echo $patient_material->url; ?>" download><i class="fa fa-download"></i> </a>
                                                                                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
            ...
            <div class="modal-body">
                <form role="form" action="patient/addNewFolder" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group d-flex">
                        ...
                        <input type="text" class="form-control col-sm-9" name="folder_name" placeholder="" required="">
                    </div>
...
<div class="modal fade" id="myModalVital" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add'); ?> <?php echo lang('vital_sign'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form role="form" action="patient/addNewVitalSign" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('heart_rate'); ?>(bpm) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="heart_rate" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('systolic_blood_pressure'); ?>(mmHg) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="systolic_blood_pressure" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('diastolic_blood_pressure'); ?>(mmHg) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="diastolic_blood_pressure" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('temperature'); ?>(&deg;C) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="temperature" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('oxygen_saturation'); ?>(%) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="oxygen_saturation" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('respiratory_rate'); ?>(bpm) </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="respiratory_rate" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('bmi_weight'); ?>(Kg) </label>
                        <input min="1" step="0.01" type="number" class="form-control col-sm-6" name="bmi_weight" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('bmi_height'); ?>(Cm) </label>
                        <input min="1" type="number" step="0.01" class="form-control col-sm-6" name="bmi_height" placeholder="">
                    </div>
...
<div class="modal fade" id="myModalVitalEdit" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit'); ?> <?php echo lang('vital_sign'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form role="form" id="editVitalSign" action="patient/addNewVitalSign" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('heart_rate'); ?>(bpm)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="heart_rate" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('systolic_blood_pressure'); ?>(mmHg)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="systolic_blood_pressure" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('diastolic_blood_pressure'); ?>(mmHg)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="diastolic_blood_pressure" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('temperature'); ?>(&deg;C)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="temperature" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('oxygen_saturation'); ?>(%)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="oxygen_saturation" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('respiratory_rate'); ?>(bpm)&ast; </label>
                        <input min="1" type="number" class="form-control col-sm-6" name="respiratory_rate" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('bmi_weight'); ?>(Kg)&ast; </label>
                        <input min="1" step="0.01" type="number" class="form-control col-sm-6" name="bmi_weight" placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-6"> <?php echo lang('bmi_height'); ?>(Cm)&ast; </label>
                        <input min="1" type="number" step="0.01" class="form-control col-sm-6" name="bmi_height" placeholder="" required="">
                    </div>
                    <input type="hidden" name="patient" value='<?php echo $patient->id; ?>'>
            ...
            <div class="modal-body">
                <form role="form" action="patient/addMedicalHistory" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="form-group d-flex col-md-12">
                        ...
                        <input type="text" class="form-control col-sm-9 form-control col-sm-9-inline input-medium default-date-picker" name="date" value='' placeholder="" autocomplete="off" required="">
                    </div>
                    <div class="form-group d-flex col-md-12">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('title'); ?> &ast;</label>
                        <input type="text" class="form-control col-sm-9 form-control col-sm-9-inline input-medium" name="title" value='' placeholder="" required="">
                    </div>
                    <div class="form-group d-flex col-md-12">
                        <label class="col-sm-3"><?php echo lang('description'); ?></label>
                        <textarea class="ckeditor form-control col-sm-9" name="description" id="editor1" value="" rows="10"></textarea>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="medical_historyEditForm" class="clearfix row" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    <div class="form-group d-flex col-md-12">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('date'); ?> &ast;</label>
                        <input type="text" class="form-control col-sm-9 form-control col-sm-9-inline input-medium default-date-picker" name="date" value='' placeholder="" readonly="" required="">
                    </div>
                    <div class="form-group d-flex col-md-12">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('title'); ?> &ast;</label>
                        <input type="text" class="form-control col-sm-9 form-control col-sm-9-inline input-medium" name="title" value='' placeholder="" required>
        ...
        <div class="modal-body">
            <form role="form" action="appointment/addNew" id="addAppointmentForm" class="form-row" method="post" enctype="multipart/form-data">
                <div class="form-group d-flex col-md-6">
                    ...
                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                        <select class="form-control col-sm-9 m-bot15 js-example-basic-single pos_select" id="pos_select" name="patient" value='' required="">
                    ...
                    ?>
                        <select class="form-control col-sm-9 js-example-basic-single pos_select" id="pos_select" name="patient" value='' required>
                            <option value="<?php echo $patients->id; ?>" selected="selected"><?php echo $patients->name; ?></option>
                        </select>
                    <?php } ?>
                </div>

                <div class="form-group d-flex col-md-6 doctor_div">
                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('doctor'); ?> &#42;</label>
                    <select class="form-control col-sm-9 m-bot15" id="adoctors" name="doctor" value='' required="">
                ...
                <div class="form-group d-flex col-md-6">
                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('date'); ?> &#42;</label>
                    <input type="text" class="form-control col-sm-9 default-date-picker" id="date" required="" name="date" value='' placeholder="" onkeypress="return false;" autocomplete="off">
                </div>

                <div class="form-group d-flex col-md-6 aslots">
                ...
                <div class="form-group d-flex col-md-6">
                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang(''); ?> <?php echo lang('status'); ?></label>
                ...
                <div class="form-group d-flex col-md-6 status_paid_hidden_section">
                ...
                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                    <div class="form-group d-flex col-md-6">
                        ...
                        <input type="text" class="form-control col-sm-9" name="remarks" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang(''); ?> <?php echo lang('charges'); ?></label>
                        <input type="number" class="form-control col-sm-9" name="visit_charges" id="visit_charges" value='' placeholder="" readonly="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('discount'); ?></label>
                        <input type="number" class="form-control col-sm-9" name="discount" id="discount" value='0' placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('grand_total'); ?></label>
                        <input type="number" class="form-control col-sm-9" name="grand_total" id="grand_total" value='0' placeholder="" readonly="">
                    </div>
                <?php } else { ?>
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('visit'); ?> <?php echo lang('charges'); ?></label>
                        <input type="number" class="form-control col-sm-9" name="visit_charges" id="visit_charges" value='' placeholder="" readonly="">
                    </div>


                    <input type="hidden" class="form-control col-sm-9" name="discount" id="discount" value='0' placeholder="">

                    <input type="hidden" class="form-control col-sm-9" name="grand_total" id="grand_total" value='0' placeholder="" readonly="">

                <?php } ?>
                <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                    <div class="form-group d-flex col-md-6">
                        <label for="" class="col-sm-3"> <?php echo lang('pay_now'); ?></label><br>
                    ...
                    <div class="payment_label col-md-6 row d-none deposit_type" style="text-align: left !important ;margin: 0% !important ;">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('deposit_type'); ?></label>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="cardPayment">
                            ...
                            <?php if ($payment_gateway != 'Paymob') { ?>
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('accepted'); ?> <?php echo lang('cards'); ?></label>
                            ...
                            ?>
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('card'); ?> <?php echo lang('type'); ?></label>
                            ...
                            ?>
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('cardholder'); ?> <?php echo lang('name'); ?></label>
                            ...
                            <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('card'); ?> <?php echo lang('number'); ?></label>
                                ...
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('expire'); ?> <?php echo lang('date'); ?></label>
                                ...
                                <div class="form-group d-flex col-md-12 payment pad_bot">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('cvv'); ?> </label>
            ...
            <div class="modal-body">
                <form role="form" id="editAppointmentForm" class="clearfix row" action="appointment/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('patient'); ?> &#42;</label>
                        <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                            <select class="form-control col-sm-9 m-bot15 js-example-basic-single pos_select patient" name="patient" value='' required="">
                                <option value="<?php echo $patient->id; ?>"><?php echo $patient->name; ?> </option>
                            </select>
                        <?php } else {
                            $user = $this->ion_auth->get_user_id();
                            $patients = $this->db->get_where('patient', array('ion_user_id' => $user))->row();
                        ?>
                            <select class="form-control col-sm-9 js-example-basic-single" id="" name="patient" value='' required>
                                <option value="<?php echo $patients->id; ?>" selected="selected"><?php echo $patients->name; ?> </option>
                            </select>
                        <?php } ?>
                    </div>

                    <div class="form-group d-flex col-md-6 doctor_div1">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('doctor'); ?> &#42;</label>
                        <select class="form-control col-sm-9 m-bot15 doctor" id="adoctors1" name="doctor" value='' required="">
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('date'); ?> &#42;</label>
                        <input type="text" class="form-control col-sm-9 default-date-picker" id="date1" required="" name="date" value='' placeholder="" onkeypress="return false;" readonly>
                    </div>
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label class="col-sm-3"><?php echo lang('time_slot'); ?></label>
                        <select class="form-control col-sm-9 m-bot15" name="time_slot" id="aslots1" value=''>
                    ...
                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                        ...
                        <div class="form-group d-flex col-md-6 d-none consultant_fee_div">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang(''); ?> <?php echo lang('charges'); ?></label>
                            <input type="number" class="form-control col-sm-9" name="visit_charges" id="visit_charges1" value='' placeholder="" readonly="">
                        </div>
                        <div class="form-group d-flex col-md-6 d-none consultant_fee_div">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('discount'); ?></label>
                            <input type="number" class="form-control col-sm-9" name="discount" id="discount1" value='0' placeholder="">
                        </div>
                        <div class="form-group d-flex col-md-6 d-none consultant_fee_div">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('grand_total'); ?></label>
                            <input type="number" class="form-control col-sm-9" name="grand_total" id="grand_total1" value='0' placeholder="" readonly="">
                        </div>
                    <?php } else { ?>
                        <div class="form-group d-flex col-md-8">
                            <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('remarks'); ?></label>
                        ...
                        <input type="hidden" class="form-control col-sm-9" name="discount" id="discount1" value='0' placeholder="">

                        <input type="hidden" class="form-control col-sm-9" name="grand_total" id="grand_total1" value='0' placeholder="" readonly="">

                    <?php } ?>
                    <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                        <div class="form-group d-flex col-md-12 d-none pay_now">
                            <label for="" class="col-sm-3"> <?php echo lang('pay_now'); ?></label><br>
                            <input type="checkbox" id="pay_now_appointment1" name="pay_now_appointment" value="pay_now_appointment">
                            <span style="color:red;"><?php echo lang('if_pay_now_checked_please_select_status_to_confirmed') ?></span>
                        </div>
                        <div class="form-group d-flex col-md-6 d-none payment_status form-group">
                            <label for="" class="col-sm-3"> <?php echo lang('payment'); ?> <?php echo lang('status'); ?></label><br>
                            <input type="text" class="form-control col-sm-9" id="pay_now_appointment" name="payment_status_appointment" value="paid" readonly="">
                        </div>
                        <div class="form-group d-flex payment_label col-md-6 d-none deposit_type1" style="text-align: left !important ;margin: 0% !important ;">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('deposit_type'); ?></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card1">
                                ...
                                <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                                    ...
                                    <div class="form-group d-flex col-md-12 payment pad_bot">
                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('expire'); ?> <?php echo lang('date'); ?></label>
                                        <input type="text" class="form-control col-sm-9 pay_in" id="expire1" data-date="" data-date-format="MM YY" placeholder="Expiry (MM/YY)" name="expire_date" maxlength="7" aria-describedby="basic-addon1" value='' placeholder="">
                                    </div>
                                    <div class="form-group d-flex col-md-12 payment pad_bot">
                                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('cvv'); ?> </label>
                        ...
                        <div class="col-md-12">
                            <div class="btn-block">
                                <?php $twocheckout = $this->db->get_where('paymentGateway', array('name =' => '2Checkout'))->row(); ?>
                                <div class="form-group cashsubmit1 payment  right-six">
                                    <button type="submit" name="submit2" id="submit1" class="btn btn-primary btn-block float-right"> <?php echo lang('submit'); ?></button>
                                </div>
                                <?php $twocheckout = $this->db->get_where('paymentGateway', array('name =' => '2Checkout'))->row(); ?>
                                <div class="form-group cardsubmit1  right-six d-none">
                ...
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-group d-flex col-md-6">
                            ...
                            <input type="password" class="form-control col-sm-9" name="password" placeholder="" autocomplete="on">
                        </div>
                        ...
                        <div class="form-group d-flex col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-9" name="address" value='' placeholder="">
                        </div>
                        <div class="form-group d-flex col-md-6">
                        ...
                        <div class="form-group d-flex col-md-6">
                            ...
                            <input class="col-sm-9 form-control default-date-picker" type="text" name="birthdate" value="" placeholder="" readonly="">
                        </div>


                        <div class="form-group d-flex col-md-6">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('blood_group'); ?></label>
                            <select class="form-control col-sm-9 m-bot15" name="bloodgroup" value=''>
                                <option></option>
                        ...
                        <div class="form-group d-flex col-md-6">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('doctor'); ?></label>
                            <select class="form-control col-sm-9 js-example-basic-single doctor" name="doctor" value=''>
                                <option value=""> </option>
                        ...
                        <div class="form-group d-flex last col-md-6">
