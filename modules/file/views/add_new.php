                                  ...
                                  <div class="">
                                      <div class="col-md-6">
                                          <div class="form-group d-flex">
                                              ...
                                              <input type="text" class="form-control col-sm-9" name="title" id="exampleInputEmail1" value='<?php
                                                                                                                                            if (!empty($setval)) {
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group pos_client d-flex">
                                              <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('permission_for'); ?> :</label>
                                              <div class="col-sm-9">
