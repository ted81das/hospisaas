                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <!-- <h3 class="card-title"><?php echo date('Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('sales_report'); ?></h3> -->
                            ...
                            <div class="float-right no-print mr-1">
                                <a href="finance/pharmacy/monthly?year=<?php echo $previous_year; ?>">
                                    <button title="<?php echo lang('previous'); ?>" class="btn btn-warning btn-sm">
                                        <i class="fa fa-arrow-left"></i> <?php echo lang('previous'); ?> <?php echo lang('year'); ?>
                                    </button>
                                </a>
                            </div>
                        </div>
