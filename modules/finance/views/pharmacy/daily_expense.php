    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-file-invoice-dollar mr-2"></i><?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('expense_report'); ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang('Pharmacy daily expense report for each month'); ?></h3>
                            ...
                            <div class="float-right no-print mr-1">
                                <a href="finance/pharmacy/dailyExpense?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>">
                                    <button title="<?php echo lang('nest'); ?>" class="btn btn-success btn-sm">
