    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-money-bill-wave mr-2"></i><?php echo date('F, Y', $first_minute) . ' ' . lang('hospital') . ' ' . lang('expense_report'); ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo date('F, Y', $first_minute) . ' ' . lang('hospital') . ' ' . lang('expense_report'); ?></h3>

                            <div class="float-right float-right no-print mr-1">
                                <a class="no-print float-right btn btn-sm btn-secondary" onclick="javascript:window.print();"> <i class="fa fa-print"></i> </a>
                            </div>
