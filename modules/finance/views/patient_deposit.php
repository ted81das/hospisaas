                                    ...
                                    ?>
                                        ...
                                        ?>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="no-print d-flex gap-1">
                                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                                                <a type="button" class="btn-sm btn-info editbutton edit_pay" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $deposit->id; ?>"><i class="fa fa-edit"></i>
                                                                </a>
                                                            <?php } ?>
                                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                        ...
                        <div class="hidden insurance_div">
                            ...
                            <div class="form-group" style="margin-top:10px;">
                                ...
                                <div class="company_div">
                                    <select class="form-control m-bot15 js-example-basic-single" name="insurance_company" id="insurance_company" value=''>
                        ...
                        <div class="hidden insurance_div1">
                            ...
                            <div class="form-group" style="margin-top:10px;">
                                ...
                                <div class="company_div1">
                                    <select class="form-control m-bot15 js-example-basic-single" name="insurance_company" id="insurance_company1" value=''>
                                        <option value="">Select Company</option>
                                        <?php foreach ($insurance_companys as $insurance_company) { ?>
                                            <option value="<?php echo $insurance_company->id; ?>" <?php
                                                                                                    if (!empty($setval)) {
