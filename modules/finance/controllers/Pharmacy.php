...
class Pharmacy extends MX_Controller
{
    ...
    function getPaymentList()
    {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            $option3 = '<a class="btn btn-success btn-sm" style="color: #fff;" href="finance/pharmacy/invoice?id=' . $payment->id . '"><i class="fa fa-file-invoice"></i> ' . lang('invoice') . '</a>';
            $options4 = '<a class="btn btn-secondary btn-sm invoicebutton" title="' . lang('print') . '" style="color: #fff;" href="finance/pharmacy/printInvoice?id=' . $payment->id . '"target="_blank"> <i class="fa fa-print"></i> ' . lang('print') . '</a>';
