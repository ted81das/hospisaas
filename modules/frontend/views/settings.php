                                        ...
                                        <div id="collapseFaq" class="collapse" aria-expanded="false">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title1'); ?></label>
                                                        <input type="text" class="form-control" name="question1" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description1'); ?></label>
                                                        <input type="text" class="form-control" name="answer1" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title2'); ?></label>
                                                        <input type="text" class="form-control" name="question2" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description2'); ?></label>
                                                        <input type="text" class="form-control" name="answer2" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title3'); ?></label>
                                                        <input type="text" class="form-control" name="question3" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description3'); ?></label>
                                                        <input type="text" class="form-control" name="answer3" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                                                        <input type="text" class="form-control" name="question4" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description'); ?></label>
                                                        <input type="text" class="form-control" name="answer4" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="question5" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="answer5" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                                                        <input type="text" class="form-control" name="question6" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description'); ?></label>
                                                        <input type="text" class="form-control" name="answer6" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('button_link_1'); ?></label>
                                                        <input type="text" class="form-control" name="question7" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('button_link_2'); ?></label>
                                                        <input type="text" class="form-control" name="answer7" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                                                        <input type="text" class="form-control" name="question8" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('description'); ?></label>
                                                        <input type="text" class="form-control" name="answer8" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('button_link_1'); ?></label>
                                                        <input type="text" class="form-control" name="question9" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('button_link_2'); ?></label>
                                                        <input type="text" class="form-control" name="answer9" value='<?php
