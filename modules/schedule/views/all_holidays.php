    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-calendar-alt mr-2"></i><strong><?php echo lang('holiday') ?></strong></h1>
                </div>
                <div class="col-sm-6">
                ...
                <form role="form" action="schedule/addHoliday" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class=" form-group col-md-6 d-flex">
                            ...
                            <select class="form-control col-sm-9 m-bot15" id="doctorchoose" name="doctor" value='' required="">

                            </select>
                        </div>

                        <div class="form-group col-md-6 d-flex float-right">
            ...
            <div class="modal-body">
                <form role="form" id="editHolidayForm" class="clearfix" action="schedule/addHoliday" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-md-6 d-flex">
                            <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('doctor'); ?> &ast;</label>
                            <select class="form-control col-sm-9 m-bot15" id="doctorchoose1" name="doctor" value='' required="">
