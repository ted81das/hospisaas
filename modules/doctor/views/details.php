            ...
            <div class="modal-body">
                <form role="form" action="patient/addPatientMaterial" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('title'); ?></label>
                        <input type="text" class="form-control col-sm-9" name="title" placeholder="">
                    </div>
                    <div class="form-group d-flex col-md-6">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('file'); ?></label>
                ...
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pos_client clearfix">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-md-3 payment_label">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('patient'); ?> <?php echo lang('email'); ?></label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-md-3 payment_label">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('patient'); ?> <?php echo lang('phone'); ?></label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-md-3 payment_label">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('patient'); ?> <?php echo lang('age'); ?></label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-md-3 payment_label">
                                    <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('patient'); ?> <?php echo lang('gender'); ?></label>
                                </div>
                                <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group d-flex">
                            ...
                            <input type="text" class="form-control col-sm-9" name="remarks" value='' placeholder="">
                        </div>
                        ...
                        <div class="form-group d-flex">
                            <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('send_sms') ?></label>
            ...
            <div class="modal-body">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group d-flex mt-3">
                            <label class="col-sm-3"><?php echo lang('time_slot'); ?></label>
                            <select class="form-control col-sm-9" name="time_slot" id="aslots1" value=''>
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addSchedule" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex weekday_div">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('weekday'); ?></label>
                    ...
                    <div class="form-group d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('start_time'); ?></label>
                    ...
                    <div class="form-group d-flex bootstrap-timepicker">
                        <label for="exampleInputEmail1" class="col-sm-3"> <?php echo lang('end_time'); ?></label>
                    ...
                    <div class="form-group d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('appointment') ?> <?php echo lang('duration') ?> </label>
                        <select class="form-control col-sm-9" name="duration" value=''>
                ...
                <form role="form" id="editDoctorForm" class="clearfix" action="doctor/addNew" method="post" enctype="multipart/form-data">
                    <div class="">
                        ...
                        <div class="form-group profile1 d-flex">
                            ...
                            <textarea class="form-control col-sm-9" id="editor3" name="profile" value="" rows="5" cols="20"></textarea>
