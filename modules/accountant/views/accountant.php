                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-muted"><?php echo lang('All the accountant names and related informations'); ?></h3>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($accountants as $accountant) { ?>
                                        <tr class="">
                                            ...
                                            <td class="align-middle no-print d-flex gap-1">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add_accountant'); ?></h4>
            ...
            <div class="modal-body">
                <form role="form" action="accountant/addNew" class="clearfix form-row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 d-flex">
                        ...
                        <input type="email" class="form-control col-md-9" name="email" value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('password'); ?> &#42;</label>
                        <input type="password" class="form-control col-md-9" name="password" placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('address'); ?> &#42;</label>
                        <input type="text" class="form-control col-md-9" name="address" value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('phone'); ?> &#42;</label>
                        <input type="number" class="form-control col-md-9" name="phone" value='' placeholder="" required="">
                    </div>

                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('profile'); ?> <?php echo lang('description'); ?> &ast; </label>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit_accountant'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form role="form" id="editAccountantForm" class="clearfix form-row" action="accountant/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('name'); ?> &#42;</label>
                        <input type="text" class="form-control col-md-9" name="name" value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('email'); ?> &#42;</label>
                        <input type="email" class="form-control col-md-9" name="email" value='' placeholder="" required="">
                    ...
                    <div class="form-group col-md-6 d-flex">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('password'); ?></label>
                        <input type="password" class="form-control col-md-9" name="password" placeholder="********">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1" class="col-sm-3"><?php echo lang('profile'); ?> <?php echo lang('description'); ?></label>
