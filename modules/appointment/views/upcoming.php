                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang('All the upcoming appointments'); ?></h3>
                    ...
                    <div class="form-row">
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                            ...
                            <div class="col-md-12 d-none payment_status form-group">
                                ...
                                <input type="text" class="form-control" id="pay_now_appointment2" name="payment_status_appointment" value="paid" readonly="">
